...
# web application at http://frankrunsfast.pythonanywhere.com/
...
#import sys
#
#path = '/home/frankrunsfast/path/to/my/app
...
import sys
#
## assuming your django settings file is at '/home/frankrunsfast/mysite/settings.py'
path = '/home/frankrunsfast/BeforeHeShrugged'
if path not in sys.path:
    sys.path.append(path)
#
os.environ['DJANGO_SETTINGS_MODULE'] = 'beforeheshrugged.settings'
#
## then, for django >=1.5:
...
#import sys
#
#path = '/home/frankrunsfast/path/to/flask_app_directory'
#if path not in sys.path:
#    sys.path.append(path)
#
